...
export const Cadastrar = () => {
  ...
  return (
    <div className='d-flex align-items-center justify-content-center'  style={{height: "100vh"}}>
      <div className='border rounded p-5' style={{backgroundColor: '#20B2AA', borderRadius: "25px"}}>
        ...
        <Button  style={{backgroundColor: '#1E90FF', borderColor: "#1E90FF", marginTop: "10px"}} type="submit">
          Cadastrar
        </Button>
